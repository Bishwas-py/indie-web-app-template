...
export default function Sidebar() {
    ...
    return (
        <div
            className={`${open ? "w-64 sm:relative ultra-sm:fixed ultra-sm:w-10/12" : "w-20"} relative align-middle duration-700 transition-all h-screen p-3 pt-8 bg-dark-purple`}>
            ...
            <div className={`flex ${!open ? "p-2 w-12 self-center mx-auto" : "py-2 px-3 gap-x-4"} items-center` +
